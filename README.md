...
<!-- ./db_bench --benchmarks=fillrandom --threads=1 --key_size=16 --value_size=32 --num=10000000 --bloom_bits=10 --readwritepercent=5 --compute_node_id=0 --fixed_compute_shards_num=0 -->
